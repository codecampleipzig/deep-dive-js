...
function greeting(name, language) {
   ...
   if (language == "English") {
      ...
      throw("Error"); // You don't need the (), because throw is a keyword not a function. Also you shouldn't throw strings, but actual Error objects: new Error("The error message")
   }
