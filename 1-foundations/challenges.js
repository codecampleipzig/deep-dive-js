...
function greeting(name, language) {
  ...
  if (!hello) {
    ...
    // can you attach a message to the error?
...
function fileExtension(filename) {
  // TODO: lastIndexOf returns a number not a string. It returns -1 if the element can't be found
